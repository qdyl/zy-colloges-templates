...
$(function(){
	...
	$(".Banners").slide({titCell:".ulMark li",mainCell:".AnimUl",effect:"leftLoop",vis:1,autoPlay:true,interTime:6288,easing:"easeInOutQuint",delayTime:888, startFun: function(i, c) {
...
strTemp+="<li><div class='DName'><a href='Doctor-"+this.DID+".html' target='_blank' class='name'>"+this.DName+"</a><div><a href='Doctor-"+this.DID+".html' target='_blank'><img src='images/nophoto.gif' data-images='"+this.DImage+"'  width='99' height='133' /></a><label>"+this.DName+"</label><em>"+this.OfficeName+"</em><span>"+this.Position+"</span><a href='Doctor-"+this.DID+".html' target='_blank' class='more'>详细</a> <a href='NewsDetail-449.html' target='_blank' class='date'>预约</a></div></div><p class='animated'>"+this.OfficeName+"</p></li>";
					   });
